...
Repositório privado para arquivamento das entregas contratuais do IDECACE (cronogramas, relatórios circunstanciados, termos de recebimento, registros fotográficos e materiais pedagógicos).

## Estrutura

Todos os anexos ficam na pasta `IDECACE-Entregas/`.

## Bloco 1 (17/06/2026)

- `ANEXO-2-Cronograma-Empenho.pdf`
- `ANEXO-3-Relatorio-Circunstanciado-2.pdf`
- `ANEXO-4-Cronograma-Prorrogacao-Jun-Set26-3.pdf`
- `ANEXO-6-Relatorio-Fotografico-Entrega-Materiais-Pedagogicos-Cartilhas-4.pdf`
- `ANEXO-7-Termo-de-Recebimento-Cruzeiro-do-Sul-5.pdf`
- `ANEXO-8-Termo-de-Recebimento-Rio-Branco-Pag-01-a-40-6.pdf`

## Bloco 2 (17/06/2026)

- `ANEXO-9-Termo-de-Recebimento-Rio-Branco-Pag-41-a-Final.pdf`
- `Anexo_Fotografico_Padronizado-ASAI-2.pdf`
- `Comunicacao-Interna-SEE-ao-IDECACE-3.pdf`
